...
; 8x8 サイズのタイルセットを反転描画する
;
_xcs_invert_8x8_tile:
...
.xcs_invert_8x8_tile_loop
    ...
    inc     hl
    dec     d
    jr      nz, xcs_invert_8x8_tile_loop
...
_xcs_overlay_8x8_tile:
    ...
    ld      bc, xcs_tile_8x8
    ld      a, $03
.xcs_overlay_8x8_tile_mask_loop
    push    af
    ld      a, (de)     ; 0
    and     (hl)
    ld      (bc), a
    ...
    pop     af
    dec     a
    jr      z, xcs_overlay_8x8_tile_merge
    dec     hl
    dec     hl
    dec     hl
    dec     hl
    ...
    dec     hl
    dec     hl
    jr      xcs_overlay_8x8_tile_mask_loop

    ; 重ね合わせる
.xcs_overlay_8x8_tile_merge
    inc     hl
    ld      de, xcs_tile_8x8
    ex      de, hl
    ld      b, $03
.xcs_overlay_8x8_tile_merge_loop
    ld      a, (de)     ; 0
    or      (hl)
    ld      (hl), a
    inc     de
    ...
    inc     de
    inc     hl
    djnz    xcs_overlay_8x8_tile_merge_loop
